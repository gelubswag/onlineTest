...
class Question(models.Model):
    ...
    text = models.TextField(verbose_name="Вопрос", max_length=5048, default="", blank=True, null=False)
    ...
    imageHeight = models.PositiveBigIntegerField(
        verbose_name="Высота изображения в пикселях", default=200
        )
    
    imageWidth = models.PositiveBigIntegerField(
        verbose_name="Высота изображения в пикселях", default=200
        )
...
class Option(models.Model):
    ...
    imageWidth = models.PositiveBigIntegerField(
        verbose_name="Ширина изображения в пикселях", default=200
        )
...
class UserTest(models.Model):
    ...
    time_end = models.DateTimeField(verbose_name="Конец", null=True)
